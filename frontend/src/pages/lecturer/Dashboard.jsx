...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Separate based on status or deadline
      ...
      // Optionally fetch unassigned count for each active project
      const stats = [];
    ...
    <DashboardLayout>
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Left Column - Active Group Tables */}
