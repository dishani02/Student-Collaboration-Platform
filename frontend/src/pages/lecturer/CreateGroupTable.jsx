...
const CreateGroupTable = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.module) {
      toast.error('Select a module from your teaching list.');
      return;
    }
  ...
  const moduleOptions = myModules.map((m) => ({
    value: m.code,
    label: `${m.code} — ${m.name}`
  }));
      ...
      <div className="p-8 max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">
            Configure an assignment for one of the modules you teach (from your profile).
          </p>
        </div>
          ...
          {teachingCodes.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Add the modules you teach under <strong>Teaching Modules</strong> in your profile. Only those modules
                appear here when creating a group table.
              </p>
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-4 max-w-md mx-auto text-sm">
                Your profile lists: {teachingCodes.join(', ')}. None were found in the system module list. Check codes or
                contact an administrator.
              </p>
              <Link to="/lecturer/profile" className="text-primary-600 font-medium text-sm hover:underline">
                Edit teaching modules
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6 p-1">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  />
                  <Select
                    label="Module (your teaching modules only)"
                    name="module"
                    value={formData.module}
                    onChange={handleChange}
                    options={moduleOptions}
                    placeholder="Select module code and name"
                    required
                  />
                </div>
              ...
              <div className="pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Input
                    ...
                    onChange={handleChange}
                    helperText={`Total capacity: ${formData.numberOfGroups * formData.groupSize} students`}
                    required
                  />
                  <Input
              ...
              <div className="pt-6 border-t border-gray-100 flex justify-end gap-3">
                <Button type="button" variant="outline" onClick={() => navigate('/lecturer/groups')}>
                  Cancel
                </Button>
